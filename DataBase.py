...
class DataBase:
    def __init__(self, address='localhost', port='5434', login='myUser',
                 password='mypassword1', db_name='myDb', sql_file_source='sql_sources.sql'):
        ...
        conn = psycopg2.connect(host=address, port=port, dbname=db_name, user=login, password=password)
